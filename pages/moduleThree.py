...
class ModuleThree(tk.Frame):
    ...
    def add_content(self):
        self.label = tk.Label(self.scrollable_frame, text="Module 3", font=("Helvetica", 18))
        self.label.pack(pady=20)

        self.content_titlu_unu = tk.Label(self.scrollable_frame, text="Text 3.1 - Text", justify="left", wraplength=1310, font=(16))
        ...
        self.content_titlu_doi = tk.Label(self.scrollable_frame, text="Text 3.2 - Text", justify="left", wraplength=1310, font=(16))
        self.content_titlu_doi.pack(anchor="w", padx=20, pady=10)

        self.label5 = tk.Label(self.scrollable_frame, text="1.	Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit quisquam enim eaque libero ut, at quibusdam excepturi praesentium tempore! Consectetur placeat facilis exercitationem eius unde molestias sit maiores odit asperiores voluptatum? Dolore delectus praesentium dolores id quibusdam blanditiis, nostrum veniam nisi, reiciendis repudiandae voluptate explicabo natus perferendis repellat ullam labore.", justify="left", wraplength=1310)
        self.label5.pack(anchor="w", padx=20, pady=10)

        self.label6 = tk.Label(self.scrollable_frame, text="2.Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit quisquam enim eaque libero ut, at quibusdam excepturi praesentium tempore! Consectetur placeat facilis exercitationem eius unde molestias sit maiores odit asperiores voluptatum? Dolore delectus praesentium dolores id quibusdam blanditiis, nostrum veniam nisi, reiciendis repudiandae voluptate explicabo natus perferendis repellat ullam labore.", justify="left", wraplength=1310)
        self.label6.pack(anchor="w", padx=20, pady=10)

        self.label7 = tk.Label(self.scrollable_frame, text="3.	Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit quisquam enim eaque libero ut, at quibusdam excepturi praesentium tempore! Consectetur placeat facilis exercitationem eius unde molestias sit maiores odit asperiores voluptatum? Dolore delectus praesentium dolores id quibusdam blanditiis, nostrum veniam nisi, reiciendis repudiandae voluptate explicabo natus perferendis repellat ullam labore..", justify="left", wraplength=1310)
        self.label7.pack(anchor="w", padx=20, pady=10)

        self.content_titlu_trei = tk.Label(self.scrollable_frame, text="Text 3.3 – Text", justify="left", wraplength=1310, font=(16))
        self.content_titlu_trei.pack(anchor="w", padx=20, pady=10)
        ...
        self.content_titlu_patru = tk.Label(self.scrollable_frame, text="Text 3.4 – Text", justify="left", wraplength=1310, font=(16))
        self.content_titlu_patru.pack(anchor="w", padx=20, pady=10)

        self.label10 = tk.Label(self.scrollable_frame, text="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit quisquam enim eaque libero ut, at quibusdam excepturi praesentium tempore! Consectetur placeat facilis exercitationem eius unde molestias sit maiores odit asperiores voluptatum? Dolore delectus praesentium dolores id quibusdam blanditiis, nostrum veniam nisi, reiciendis repudiandae voluptate explicabo natus perferendis repellat ullam labore." * 20, justify="left", wraplength=1310)
